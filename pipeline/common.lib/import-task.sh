...
kubectl describe cm tn-job-appprop-cm tn-importexportscript-cm webmethodslicensekeys tn-utilfiles-cm
...
kubectl delete cm tn-dataload-cm tn-job-appprop-cm tn-importexportscript-cm
